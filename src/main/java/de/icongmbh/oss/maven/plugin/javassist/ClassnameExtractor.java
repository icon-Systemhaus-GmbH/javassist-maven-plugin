...
public class ClassnameExtractor {
    ...
    /**
     * Remove parent directory from file name and replace directory separator
     * with dots.
     * <p>
     * e.g.:
     * </p>
     ...
     *
     * @param parentDirectory to remove from {@code classFile} and maybe
     * {@code null}.
    ...
    /**
     * Iterate over the class files and remove the parent directory from file
     * name and replace directory separator with dots.
     *
     * @param parentDirectory to remove from {@code classFile} and maybe
     * {@code null}.
     * @param classFiles array to extract the names from. Must not be
     * {@code null}.
    ...
    /**
     * Wrapping the iterator (as reference) of class file names and extract full
     * qualified class name on {@link Iterator#next()}.
     * <p>
     * It is possible that {@link Iterator#hasNext()} returns {@code true} and
     * {@link Iterator#next()} returns {@code null}.
     * </p>
     *
     * @param parentDirectory to remove from {@code classFile} and maybe
     * {@code null}.
     * @param classFileIterator to extract the names from. Must not be
     * {@code null}.
     * @return iterator of full qualified class names based on passed classFiles
     * or {@code null}
    ...
    /**
     * Wrapping the list (as reference) of class file names and extract full
     * qualified class name on {@link Iterator#next()}.
     * <p>
