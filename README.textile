...
p. <a href="https://maven-badges.herokuapp.com/maven-central/de.icongmbh.oss.maven.plugins/javassist-build-plugin"><img src="https://maven-badges.herokuapp.com/maven-central/de.icongmbh.oss.maven.plugins/javassist-build-plugin/badge.svg" /></a> <a href="https://travis-ci.org/icon-Systemhaus-GmbH/javassist-maven-plugin"><img src="https://travis-ci.org/icon-Systemhaus-GmbH/javassist-maven-plugin.svg" /></a>
